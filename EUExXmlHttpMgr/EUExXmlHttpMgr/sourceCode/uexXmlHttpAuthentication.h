/**
 *
 *	@file   	: uexXmlHttpAuthentication.h  in EUExXmlHttpMgr
 *
 *	@author 	: CeriNo 
 * 
...
@interface uexXmlHttpAuthentication : NSObject


@property (nonatomic,strong)NSData *PKGCS12ClientCertificateData;
