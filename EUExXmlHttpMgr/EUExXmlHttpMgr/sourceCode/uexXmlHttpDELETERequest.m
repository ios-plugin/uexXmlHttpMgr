...
@interface uexXmlHttpDELETERequest()
@property (nonatomic,strong)NSData *bodyData;

@end

@implementation uexXmlHttpDELETERequest
...
- (void)setDELETEBody:(NSData *)bodyData{
    if(!bodyData){
        return;
    }
...
- (uexXmlHttpRequestMethod)method{
    return uexXmlHttpRequestMethodDELETE;
}

- (void)setBody:(NSData *)bodyData {
    [self setDELETEBody:bodyData];
}
